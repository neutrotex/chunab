              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                ...
                <div className="text-xs text-amber-700 dark:text-amber-300 space-y-2">
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-2">
                    <li>The information provided in this complaint is genuine, truthful, and based on my personal knowledge and observations. / यो उजुरीमा प्रदान गरिएको जानकारी प्रामाणिक, सत्य र मेरो व्यक्तिगत ज्ञान र अवलोकनमा आधारित छ।</li>
